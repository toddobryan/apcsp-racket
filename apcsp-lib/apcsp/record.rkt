...
(require racket/struct
         "apcsp-racket/private/primitives.rkt"
         "../signature/signature.rkt"
         "../signature/signature-syntax.rkt"
         "../signature/signature-unit.rkt"
         (only-in "apcsp-racket-signature/apcsp-racket/quickcheck/quickcheck.rkt"
                  arbitrary-record))

(require (for-syntax "apcsp-racket/private/syntax-checkers.rkt")
